...
namespace biblioteka
{
    internal class Data
    {
        ...
        public static List<string> ListaNapomena = new List<string>();
        ...
        public void SacuvajUFajlCSV(string filePath)
        {
            try
            {
                ...
                string csvData = $"{pom.ID},{pom.Status},{pom.Ime},{pom.Prezime},{pom.ImeJednogRoditelja},{pom.Pol},{pom.DanRodjenja},{pom.MesecRodjenja},{pom.GodinaRodjenja},{pom.JMBG},{pom.AdresaUlicaBr},{pom.AdresaGrad},{pom.AdresaPostanskiBr},{pom.Telefon},{pom.Mail},{pom.StepenStrucneSpreme},{pom.SkolskoZvanje},{pom.TrenutniRadniStatus},{pom.BrojIDDokumenta},{pom.BrojClanskeKarte},{pom.PrviUpis},{pom.ProduzenjeClanstva},{pom.IznosClanarine},{pom.TrajanjeClanstva},{FormatirajListuSvihKnjiga()},{FormatirajListuTrenutnoUzetihKnjiga()},{string.Join(";", pom.Napomena)}";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                List<string> napomene = dodajCitaoca.richTextBox1.Lines.ToList<string>();

                List<Tuple<string, string, DateTime, DateTime, string, bool>> listaSvihKnjiga = new List<Tuple<string, string, DateTime, DateTime, string, bool>>();
                foreach (var knjiga in dodajCitaoca.comboBox3.Items)
                {

                    listaSvihKnjiga.Add((Tuple<string, string, DateTime, DateTime, string, bool>)knjiga);
                }

                List<Tuple<string, string, DateTime, DateTime, string>> listaTrenutnoUzetihKnjiga = new List<Tuple<string, string, DateTime, DateTime, string>>();
                foreach (var knjiga in dodajCitaoca.comboBox4.Items)
                {

                    listaTrenutnoUzetihKnjiga.Add((Tuple<string, string, DateTime, DateTime, string>)knjiga);
                }

                dodajCitaoca.dateTimePicker2.Value = DateTime.Now;
                dodajCitaoca.dateTimePicker3.Value = DateTime.Now;

                dodajCitaoca.dateTimePicker4.Value = DateTime.Now.AddMonths(1);
                ...
                Citalac c = new Citalac(
                        ...
                        dodajCitaoca.dateTimePicker1.Value.Day,
                        dodajCitaoca.dateTimePicker1.Value.Month,
                        dodajCitaoca.dateTimePicker1.Value.Year,
                        dodajCitaoca.textBox5.Text,
                        dodajCitaoca.textBox6.Text,
                        dodajCitaoca.textBox17.Text,
                        int.Parse(dodajCitaoca.textBox18.Text),
                ...
                Data.DodajCitaoca(c);
                Data.SacuvajCitaoce(@"C:\Users\veljk\OneDrive\Desktop\citaoci.csv");
                popuniComboBox();
        ...
        private void popuniComboBox()
        {
            ...
            FormaCitaoc forma = new FormaCitaoc();
            // Očistite postojeće stavke u ComboBox-u
            forma.comboBox1.Items.Clear();

            // Dodajte sve čitaoce iz liste u ComboBox
            foreach (var citalac in Data.ListaCitalaca)
            {
                forma.comboBox1.Items.Add(citalac.Ime + " " + citalac.Prezime);
            }
        }
